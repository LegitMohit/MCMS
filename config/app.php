...
return [
    ...
    'Session' => [
        'defaults' => 'php',
        'timeout' => 8760, // 365 days in hours
        'cookieTimeout' => 525600, // 365 days in minutes
        'ini' => [
            'session.cookie_secure' => false,
            'session.cookie_httponly' => true,
            'session.gc_maxlifetime' => 31536000, // 365 days in seconds
            'session.cookie_lifetime' => 31536000, // 365 days in seconds
            'session.gc_probability' => 0, // Disable garbage collection
